...
// flood.renderSpeed = 900;
flood.maxLevel = 160; // Server - Do not Edit.
...
window.addEventListener("DOMContentLoaded", async () => {
	...
	<div id="flood-menu">
		...
		<a href="${flood.ringPage}" target="${flood.ringTarget}">${flood.msg.info}</a>
	</div>`
    );
...
async function updateFloodLevel(doBilge = false, doQuickUpdate = true) {
